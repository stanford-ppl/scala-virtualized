...
object SourceContext {
  ...
  def apply(path: String, fileName: String, line: Int, column: Int, methodName: String, assignedVariable: Option[String],parent:Option[SourceContext]): SourceContext =
    new ConcreteSourceContext(path, fileName, line, column, methodName, assignedVariable, parent)

  private class ConcreteSourceContext(val path: String, val fileName: String, val line: Int, val column: Int, val methodName: String, val assignedVariable: Option[String], val parent: Option[SourceContext]) extends SourceContext
}
...
private object SourceContextMacro {
  ...
  def impl(c: Context): c.Expr[SourceContext] = {
    ...
    c.Expr(q"SourceContext($path, $filename, $line, $column, $methodName, $assignedVariable, $parent)")
  }
}
